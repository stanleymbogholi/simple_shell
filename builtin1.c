#include "shell.h"
/**
 * _myhistory - displays the history list, one command per line, followed by line numbers, staring at 0.
 ...
 * @info: Structure containing potential argumnets. Used to maintain constant function prototype
 * Return: Always 0
 */
